...
while len(visited) < 500:  # when visited is less than number of rooms...
    # sets the current exit for the current visited room
    ...
    if len(unexplored_exits) > 0:
        last_room = player.currentRoom.id  # the current room is set as the previous
        # the first unexplored exit is now the direction we take
        ...
        # the current room is now set as the entered room.
        ...
        # last room needs to have the directions flipped of the entered room.
        visited[entered_room][flipped_directions[direction]] = last_room
